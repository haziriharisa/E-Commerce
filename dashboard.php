    ...
    <main class="main-content">
        ...
        <div class="dashboard-body">
            <div class="welcome-section">
                <h1>Overview</h1>
                <p style="color: #6b7280">Welcome back! Here's your business performance today.</p>
            </div>
